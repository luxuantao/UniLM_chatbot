...
import sys
sys.path.append('..')
from config import is_cuda, root_path, max_sequence_length, bert_model
...
def main(train_file,
    ...
    train_data = DataPrecessForSentence(bert_tokenizer, train_file, max_char_len=max_sequence_length)
    train_loader = DataLoader(train_data, shuffle=True, batch_size=batch_size)
    print("\t* Loading validation data...")
    dev_data = DataPrecessForSentence(bert_tokenizer, dev_file, max_char_len=max_sequence_length)
